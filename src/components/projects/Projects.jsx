        ...
        <div className="project-card">
          <div className="project-card-container">
            ...
            <div className="project-card-text">
              ...
              <p className="project-description">Home Elementry is an Indian online marketplace that sells 
              variety of   furniture and home décor at a affordable price with top notch quality.
              ...
              <div className="project-card-btn">
                <div
                  onClick={() => openLink(`https://github.com/uzairansari11/eminent-tin-5074.git`)}
        ...
        <div className="project-card">
          <div className="project-card-container">
            ...
            <div className="project-card-text">
              ...
              <div className="project-card-btn">
                <div
                  onClick={() => openLink(`https://github.com/uzairansari11/spicy-nerve-9354.git`)}
                  className="project-github-link"
                >
                  GitHub <FaGithub />
                </div>
        ...
        <div className="project-card">
          <div className="project-card-container">
            ...
            <div className="project-card-text">
              ...
              <p className="project-description">
              Apna-E-Cart is an Indian consumer electronics retailer. 
            It sells differnt kinds of electronic products and delivere the products within one day.
               </p>
              <div className="project-tech-stack">
                <div key={Date.now() + Math.random()}
                  className="project-skills-card">
              ...
              <div className="project-card-btn">
                <div
                  onClick={() => openLink(`https://github.com/uzairansari11/-wanting-advertisement-5951.git`)}
                  className="project-github-link"
                >
                  GitHub <FaGithub />
                </div>
        ...
        <div className="project-card">
          <div className="project-card-container">
            ...
            <div className="project-card-text">
              ...
              <p className="project-description">
            CultBody provides product related to your fintness and also provide diffrent kind of fitness trianing 
   via online and offline as per customer requirement.                </p>
              <div className="project-tech-stack">
                <div key={Date.now() + Math.random()}
                  className="project-skills-card">
                  <img
              ...
              <div className="project-card-btn">
                <div
                  onClick={() => openLink(`https://github.com/uzairansari11/-verdant-recess-5792.git`)}
                  className="project-github-link"
                >
                  GitHub <FaGithub />
                </div>
